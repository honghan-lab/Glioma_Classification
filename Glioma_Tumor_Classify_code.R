...
fig1a_1=ggplot(plot_pr_classify_glm_lasso, aes(x=Recall, y=Precision, color=factor(Class,levels=unique(Class)))) + geom_line(size=0.5) + theme_classic() + ylab("Precision (Lasso GLM)") + xlab("Recall (Lasso GLM)") + labs(color="Glioma Type") + scale_color_manual(labels = c(paste0("A (G2) (AUPRC=",signif(temp_pr_classify_glm_lasso[[1]]$auc.davis.goadrich,2),")"),paste0("A (G3) (AUPRC=",signif(temp_pr_classify_glm_lasso[[2]]$auc.davis.goadrich,2),")"),paste0("A (G4) (AUPRC=",signif(temp_pr_classify_glm_lasso[[3]]$auc.davis.goadrich,2),")"),paste0("GBM (G4) (AUPRC=",signif(temp_pr_classify_glm_lasso[[4]]$auc.davis.goadrich,2),")"),paste0("O (G2) (AUPRC=",signif(temp_pr_classify_glm_lasso[[5]]$auc.davis.goadrich,2),")"),paste0("O (G3) (AUPRC=",signif(temp_pr_classify_glm_lasso[[6]]$auc.davis.goadrich,2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2")) + theme(legend.position = c(0.425, 0.325), text = element_text(size=6), legend.key.height = unit(0.5, "lines"), legend.background = element_rect(fill = NA, colour = NA))
fig1a_2=ggplot(plot_pr_classify_glm_ridge, aes(x=Recall, y=Precision, color=factor(Class,levels=unique(Class)))) + geom_line(size=0.5) + theme_classic() + ylab("Precision (Ridge GLM)") + xlab("Recall (Ridge GLM)") + labs(color="Glioma Type") + scale_color_manual(labels = c(paste0("A (G2) (AUPRC=",signif(temp_pr_classify_glm_ridge[[1]]$auc.davis.goadrich,2),")"),paste0("A (G3) (AUPRC=",signif(temp_pr_classify_glm_ridge[[2]]$auc.davis.goadrich,2),")"),paste0("A (G4) (AUPRC=",signif(temp_pr_classify_glm_ridge[[3]]$auc.davis.goadrich,2),")"),paste0("GBM (G4) (AUPRC=",signif(temp_pr_classify_glm_ridge[[4]]$auc.davis.goadrich,2),")"),paste0("O (G2) (AUPRC=",signif(temp_pr_classify_glm_ridge[[5]]$auc.davis.goadrich,2),")"),paste0("O (G3) (AUPRC=",signif(temp_pr_classify_glm_ridge[[6]]$auc.davis.goadrich,2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2")) + theme(legend.position = c(0.425, 0.325), text = element_text(size=6), legend.key.height = unit(0.5, "lines"), legend.background = element_rect(fill = NA, colour = NA))
fig1a_3=ggplot(plot_pr_classify_glm_elasticnet, aes(x=Recall, y=Precision, color=factor(Class,levels=unique(Class)))) + geom_line(size=0.5) + theme_classic() + ylab("Precision (Elastic Net GLM)") + xlab("Recall (Elastic Net GLM)") + labs(color="Glioma Type") + scale_color_manual(labels = c(paste0("A (G2) (AUPRC=",signif(temp_pr_classify_glm_elasticnet[[1]]$auc.davis.goadrich,2),")"),paste0("A (G3) (AUPRC=",signif(temp_pr_classify_glm_elasticnet[[2]]$auc.davis.goadrich,2),")"),paste0("A (G4) (AUPRC=",signif(temp_pr_classify_glm_elasticnet[[3]]$auc.davis.goadrich,2),")"),paste0("GBM (G4) (AUPRC=",signif(temp_pr_classify_glm_elasticnet[[4]]$auc.davis.goadrich,2),")"),paste0("O (G2) (AUPRC=",signif(temp_pr_classify_glm_elasticnet[[5]]$auc.davis.goadrich,2),")"),paste0("O (G3) (AUPRC=",signif(temp_pr_classify_glm_elasticnet[[6]]$auc.davis.goadrich,2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2")) + theme(legend.position = c(0.425, 0.325), text = element_text(size=6), legend.key.height = unit(0.5, "lines"), legend.background = element_rect(fill = NA, colour = NA))
fig1a_4=ggplot(plot_pr_classify_rf, aes(x=Recall, y=Precision, color=factor(Class,levels=unique(Class)))) + geom_line(size=0.5) + theme_classic() + ylab("Precision (Random Forest)") + xlab("Recall (Random Forest)") + labs(color="Glioma Type") + scale_color_manual(labels = c(paste0("A (G2) (AUPRC=",signif(temp_pr_classify_rf[[1]]$auc.davis.goadrich,2),")"),paste0("A (G3) (AUPRC=",signif(temp_pr_classify_rf[[2]]$auc.davis.goadrich,2),")"),paste0("A (G4) (AUPRC=",signif(temp_pr_classify_rf[[3]]$auc.davis.goadrich,2),")"),paste0("GBM (G4) (AUPRC=",signif(temp_pr_classify_rf[[4]]$auc.davis.goadrich,2),")"),paste0("O (G2) (AUPRC=",signif(temp_pr_classify_rf[[5]]$auc.davis.goadrich,2),")"),paste0("O (G3) (AUPRC=",signif(temp_pr_classify_rf[[6]]$auc.davis.goadrich,2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2")) + theme(legend.position = c(0.425, 0.325), text = element_text(size=6), legend.key.height = unit(0.5, "lines"), legend.background = element_rect(fill = NA, colour = NA))
...
figs1a_1=ggroc(temp_roc_classify_glm_lasso)+theme_classic()+ylab("Sensitivity (Lasso GLM)")+xlab("Specificity (Lasso GLM)")+labs(color = "Glioma Type")+scale_color_manual(labels = c(paste0("A (G2) (AUROC=",signif(temp_roc_classify_glm_lasso[[1]]$auc[1],2),")"),paste0("A (G3) (AUROC=",signif(temp_roc_classify_glm_lasso[[2]]$auc[1],2),")"),paste0("A (G4) (AUROC=",signif(temp_roc_classify_glm_lasso[[3]]$auc[1],2),")"),paste0("GBM (G4) (AUROC=",signif(temp_roc_classify_glm_lasso[[4]]$auc[1],2),")"),paste0("O (G2) (AUROC=",signif(temp_roc_classify_glm_lasso[[5]]$auc[1],2),")"),paste0("O (G3) (AUROC=",signif(temp_roc_classify_glm_lasso[[6]]$auc[1],2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2"))+theme(legend.position = c(0.525, 0.425))+theme(text = element_text(size = 6),legend.key.height = unit(0.5, "lines"),legend.background = element_rect(fill = NA, colour = NA))
figs1a_2=ggroc(temp_roc_classify_glm_ridge)+theme_classic()+ylab("Sensitivity (Ridge GLM)")+xlab("Specificity (Ridge GLM)")+labs(color = "Glioma Type")+scale_color_manual(labels = c(paste0("A (G2) (AUROC=",signif(temp_roc_classify_glm_ridge[[1]]$auc[1],2),")"),paste0("A (G3) (AUROC=",signif(temp_roc_classify_glm_ridge[[2]]$auc[1],2),")"),paste0("A (G4) (AUROC=",signif(temp_roc_classify_glm_ridge[[3]]$auc[1],2),")"),paste0("GBM (G4) (AUROC=",signif(temp_roc_classify_glm_ridge[[4]]$auc[1],2),")"),paste0("O (G2) (AUROC=",signif(temp_roc_classify_glm_ridge[[5]]$auc[1],2),")"),paste0("O (G3) (AUROC=",signif(temp_roc_classify_glm_ridge[[6]]$auc[1],2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2"))+theme(legend.position = c(0.525, 0.425))+theme(text = element_text(size = 6),legend.key.height = unit(0.5, "lines"),legend.background = element_rect(fill = NA, colour = NA))
figs1a_3=ggroc(temp_roc_classify_glm_elasticnet)+theme_classic()+ylab("Sensitivity (Elastic Net GLM)")+xlab("Specificity (Elastic Net GLM)")+labs(color = "Glioma Type")+scale_color_manual(labels = c(paste0("A (G2) (AUROC=",signif(temp_roc_classify_glm_elasticnet[[1]]$auc[1],2),")"),paste0("A (G3) (AUROC=",signif(temp_roc_classify_glm_elasticnet[[2]]$auc[1],2),")"),paste0("A (G4) (AUROC=",signif(temp_roc_classify_glm_elasticnet[[3]]$auc[1],2),")"),paste0("GBM (G4) (AUROC=",signif(temp_roc_classify_glm_elasticnet[[4]]$auc[1],2),")"),paste0("O (G2) (AUROC=",signif(temp_roc_classify_glm_elasticnet[[5]]$auc[1],2),")"),paste0("O (G3) (AUROC=",signif(temp_roc_classify_glm_elasticnet[[6]]$auc[1],2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2"))+theme(legend.position = c(0.525, 0.425))+theme(text = element_text(size = 6),legend.key.height = unit(0.5, "lines"),legend.background = element_rect(fill = NA, colour = NA))
figs1a_4=ggroc(temp_roc_classify_rf)+theme_classic()+ylab("Sensitivity (Random Forest)")+xlab("Specificity (Random Forest)")+labs(color = "Glioma Type")+scale_color_manual(labels = c(paste0("A (G2) (AUROC=",signif(temp_roc_classify_rf[[1]]$auc[1],2),")"),paste0("A (G3) (AUROC=",signif(temp_roc_classify_rf[[2]]$auc[1],2),")"),paste0("A (G4) (AUROC=",signif(temp_roc_classify_rf[[3]]$auc[1],2),")"),paste0("GBM (G4) (AUROC=",signif(temp_roc_classify_rf[[4]]$auc[1],2),")"),paste0("O (G2) (AUROC=",signif(temp_roc_classify_rf[[5]]$auc[1],2),")"),paste0("O (G3) (AUROC=",signif(temp_roc_classify_rf[[6]]$auc[1],2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2"))+theme(legend.position = c(0.525, 0.425))+theme(text = element_text(size = 6),legend.key.height = unit(0.5, "lines"),legend.background = element_rect(fill = NA, colour = NA))
figs1a_5=ggroc(temp_roc_classify_xgb)+theme_classic()+ylab("Sensitivity (XGBoost)")+xlab("Specificity (XGBoost)")+labs(color = "Glioma Type")+scale_color_manual(labels = c(paste0("A (G2) (AUROC=",signif(temp_roc_classify_xgb[[1]]$auc[1],2),")"),paste0("A (G3) (AUROC=",signif(temp_roc_classify_xgb[[2]]$auc[1],2),")"),paste0("A (G4) (AUROC=",signif(temp_roc_classify_xgb[[3]]$auc[1],2),")"),paste0("GBM (G4) (AUROC=",signif(temp_roc_classify_xgb[[4]]$auc[1],2),")"),paste0("O (G2) (AUROC=",signif(temp_roc_classify_xgb[[5]]$auc[1],2),")"),paste0("O (G3) (AUROC=",signif(temp_roc_classify_xgb[[6]]$auc[1],2),")")), values = c("yellow2","orange2","firebrick2","purple2","lightblue2","blue2"))+theme(legend.position = c(0.525, 0.425))+theme(text = element_text(size = 6),legend.key.height = unit(0.5, "lines"),legend.background = element_rect(fill = NA, colour = NA))
...
figs2b=ggplot(temp, aes(x=Glioma_Type, y=F1, fill=Glioma_Type))+geom_bar(stat = "identity")+theme_classic()+scale_fill_manual(values=c(`GBM (G4)`="purple2",`A (G2)`="yellow2",`A (G3)`="orange2",`A (G4)`="firebrick2",`O (G2)`="lightblue2",`O (G3)`="blue2"))+xlab("Glioma Type")+ylab("F1")+ labs(fill = "Glioma Type")+theme(text = element_text(size = 6),legend.key.height = unit(0.5, "lines"),legend.key.width = unit(0.5, "lines"),legend.position = "top",legend.justification = "center",legend.direction = "horizontal")+ scale_y_continuous(breaks=seq(0,1,by=0.1))+guides(fill=guide_legend(title="Glioma\nType", nrow = 2, byrow = TRUE))
